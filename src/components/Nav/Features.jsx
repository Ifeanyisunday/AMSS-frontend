        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white shadow p-6 rounded">
              <h4 className="text-xl font-bold text-blue-400 mb-2">Expense Tracking</h4>
              <p className="text-gray-600">Monitor all your expenses in one place with detailed insights.</p>
            </div>
            <div className="bg-white shadow p-6 rounded">
              <h4 className="text-xl font-bold text-blue-400 mb-2">Budget Planning</h4>
              <p className="text-gray-600">Set and stick to your budgets with our easy-to-use tools.</p>
            </div>
            <div className="bg-white shadow p-6 rounded">
              <h4 className="text-xl font-bold text-blue-400 mb-2">Goal Setting</h4>
